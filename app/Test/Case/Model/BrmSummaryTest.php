<?php
App::uses('BrmSummary', 'Model');

/**
 * BrmSummary Test Case
 */
class BrmSummaryTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->BrmSummary = ClassRegistry::init('BrmSummary');
	}
