...
App::import('Controller','BrmBackupFile');

/**
 * A Simple QueueTask example that runs for a while.
 *
 */
class QueueBackupFileTask extends QueueTask {
 ...
 */
	public function add() {
		 ...
		 */
		if ($this->QueuedTask->createJob('BrmBackupFile', 2 * MINUTE)) {
 ...
 */
	public function run($data, $id = null) {
		...
		$backup = new BrmBackupFileController();
		$backup->constructClasses();
