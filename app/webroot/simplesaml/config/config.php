<?php
// include_once('../../Controller/Component/Enum.php');
// include_once('../../Controller/Component/SSOInfo.php');
/* 
...
$config = array (
	 ...
	 * reverse proxy).
	 */
	// 'baseurlpath'           => 'chemical/app/webroot/sso_web_app/',
	// 'baseurlpath'           => 'app/webroot/sso_web_app/',
	'baseurlpath'           => SSOInfo::base_url_path,
	'certdir'               => 'cert/',
	'loggingdir'            => 'log/',
	'datadir'               => 'data/',
	 ...
	 */
	'auth.adminpassword'		=> SSOInfo::auth_admin_password,
	...
	'technicalcontact_email'    => 'heinhtetko@brycenmyanmar.com.mm',
	 ...
	 */
	'default-wsfed-idp'	=> 'urn:federation:pingfederate:'.SSOInfo::hostname,
	...
	'memcache_store.servers' => array(
		array(
			array('hostname' => SSOInfo::hostname),
		),
	),
