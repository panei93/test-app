<?php
include_once(dirname(__FILE__) . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR.'..'. DIRECTORY_SEPARATOR.'Controller/Component/Enum.php');
include_once(dirname(__FILE__) . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR.'..'. DIRECTORY_SEPARATOR.'Controller/Component/SSOInfo.php');
...
require_once(dirname(dirname(__FILE__)) . '/simplesaml/lib/_autoload.php');
...
$configdir = dirname(dirname(__FILE__)) . '/simplesaml/config';
...
if((in_array('sso_web_app', explode('/', $_SERVER['REQUEST_URI'])) || in_array('simplesaml', explode('/', $_SERVER['REQUEST_URI']))) && !in_array('default-sp', explode('/', $_SERVER['REQUEST_URI'])) && $_REQUEST['as'] != 'default-sp'){
