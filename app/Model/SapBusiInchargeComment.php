...
/**
 * SapBusiInchargeComment Model
 *
 * @property Sap $Sap
 */
class SapBusiInchargeComment extends AppModel {
 ...
 */
     ...
     * @param sap_id
     */
    public function AdminDelFlagBusiIncharge($sap_id,$login_id) {
    
    	$param = array();
    
    	$sql  = "";
    	$sql .= " UPDATE sap_busi_incharge_comments ";
    	$sql .= " 	 SET flag = '0', ";
