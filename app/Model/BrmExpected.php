 ...
 */
class BrmExpected extends AppModel {
 ...
 */
	...
	public function getMonthlyResult ($layer_code,$term_id,$account_code) {
	 ...
	 *
	 * @param $layer_code,$term_id,$month,$account_code
	 */
	public function getYearlyExpected($layer_code,$term_id,$year,$account_code,$month_cols) 
	{	
		$param = array();
		$sql  = "";
		$sql .= " SELECT sum(".$month_cols.") As total from brm_expected";
