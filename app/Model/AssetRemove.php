 ...
 */
class AssetRemove extends AppModel {
 ...
 */
	...
	public function DeletedRemoveData($del_asset_no,$del_ba_code,$event_id){

	 $param = array();
	 $sql  = "delete from asset_removes WHERE asset_no= :asset_no and layer_code=:layer_code and asset_event_id=:asset_event_id";
