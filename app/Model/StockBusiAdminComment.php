...
/**
 * StockBusiAdminComment Model
 *
 * @property Stock $Stock
 */
class StockBusiAdminComment extends AppModel {
 ...
 */
     ...
     * @param stock_id
     */
    public function AdminDelFlagBusiAdmincomment($stock_id,$login_id) {
    
    	$param = array();
    
    	$sql  = "";
    	$sql .= " UPDATE stock_busi_admin_comments ";
    	$sql .= " 	 SET flag = '0', ";
