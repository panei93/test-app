...
/**
 * StockAccInchargeComment Model
 *
 * @property Stock $Stock
 */
class StockAccInchargeComment extends AppModel {
 ...
 */
     ...
     * @param stock_id
     */
    public function AdminDelFlagAccInchargecomment($stock_id,$login_id) {
    
    	$param = array();
    
    	$sql  = "";
    	$sql .= " UPDATE stock_acc_incharge_comments ";
    	$sql .= " 	 SET flag = '0', ";
