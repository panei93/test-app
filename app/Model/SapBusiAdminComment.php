...
/**
 * SapBusiAdminComment Model
 *
 * @property Sap $Sap
 */
class SapBusiAdminComment extends AppModel {
 ...
 */
     ...
     * @param sap_id
     */
    public function AdminDelFlagBusiAdmincomment($sap_id,$login_id) {
    
    	$param = array();
    
    	$sql  = "";
    	$sql .= " UPDATE sap_busi_admin_comments ";
    	$sql .= " 	 SET flag = '0', ";
