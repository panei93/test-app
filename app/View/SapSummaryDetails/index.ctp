...
<script>
	...
	function Download_Report(){
		document.forms[0].action = "<?php echo $this->webroot; ?>SapSummaryDetails/Download_Summary_Rpt";
						...
						<div class="table-responsive" >
							<table class="table table-bordered" style="margin-top:10px;width:100%;" id="tbl_manager_comment">
								<thead class="check_period_table">								
										...
										<th width="5%" class="table-middle" style="vertical-align : middle;text-align:center;" ><?php echo __("Σコード"); ?></th>
										<th width="5%" class="table-middle" style="vertical-align : middle;text-align:center;" ><?php echo __("取引先名"); ?></th>
										<th width="6%" class="table-middle" style="vertical-align : middle;text-align:center;" ><?php echo __("物流Index No."); ?></th>
								...
								<tbody>
									<?php foreach($previous_month_30_result as $result4){
										...
										$account_name = h($result4['tbl_2']['account_name']);
										$destination_code = h($result4['tbl_2']['destination_code']);
										$destination_name = h($result4['tbl_2']['destination_name']);
										$logistic_index_no = h($result4['tbl_2']['logistic_index_no']);
										$due_date = h($result4['tbl_2']['schedule_date']);
										$money_amount = h($result4['tmp']['jp_amount']);
									...
									<tr>
										...
										<td style="width: 5%; word-wrap: break-word;"><?php echo $account_name; ?></td>
										...
										<td style="width: 6%; word-wrap: break-word;" class = "log_index_no"><?php echo $logistic_index_no; ?></td>
										<td style="width: 10%; word-wrap: break-word;"><?php echo $due_date; ?></td>
							...
							<table class="table table-bordered" style="margin-top:10px;width:100%;" id="longterm_debt2">
								...
								<tbody>
									<?php foreach($previous_month_60_result as $result5){
										...
										$account_name = h($result5['tbl_2']['account_name']);
										$destination_code = h($result5['tbl_2']['destination_code']);
										$destination_name = h($result5['tbl_2']['destination_name']);
										$logistic_index_no = h($result5['tbl_2']['logistic_index_no']);
										$due_date = h($result5['tbl_2']['schedule_date']);
										$money_amount = h($result5['tmp']['jp_amount']);
									...
									<tr>
										<td style="width: 5%; word-wrap: break-word;"><?php echo $layer_name; ?></td>
										<td style="width: 5%; word-wrap: break-word;"><?php echo $account_name; ?></td>
										<td style="width: 5%; word-wrap: break-word;" class = "dest_code_1"><?php echo $destination_code; ?></td>
										<td style="width: 5%; word-wrap: break-word;" class = "dest_name_1"><?php echo $destination_name; ?></td>
										<td style="width: 6%; word-wrap: break-word;" class = "log_index_no_1"><?php echo $logistic_index_no; ?></td>
										<td style="width: 10%; word-wrap: break-word;"><?php echo $due_date; ?></td>
