<!-- Modal -->
<div class="modal fade" id="myPOPModal3" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
...
<script type="text/javascript">
	$("#closePop2").on('click',function () {
		$("#myPOPModal3").fadeOut("slow");
		$("#myPOPModal3").css({"display":"none","padding-right":0});
		$("#autoCompleteTo2").val('');
		$("#autoCompleteCC2").val('');
		$("#errorMail").text('');
	});
