                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="myNavbar">
    					<ul class="nav navbar-nav menu_active">
    						<?php if(in_array('StockImports', $menus)) { ?>
                                <li>
                                    <a href="<?php echo $this->webroot; ?>StockImports/index" class="menuitem stockimports"><?php echo __("滞留在庫データインポート");?></a>
                                </li>
                            <?php } ?>
							<?php if(in_array('StockAccountPreviews', $menus)) { ?>
                                <li>
                                    <a href="<?php echo $this->webroot; ?>StockAccountPreviews/index" class="menuitem stockaccountpreviews"><?php echo __("経理プレビュー");?></a>
                                </li>
                            <?php } ?>
                            <?php if(in_array('StockAddComments', $menus)) { ?>
                                <li>
                                    <a class="menuitem stockaddcomments" href="<?php echo $this->webroot; ?>StockAddComments/index"><?php echo __("コメント追加");?></a>
                                </li>
                            <?php } ?>
                            <?php if(in_array('StockAccountReviews', $menus)) { ?>
                                <li>
                                    <a class="menuitem stockaccountreviews" href="<?php echo $this->webroot; ?>StockAccountReviews/index"><?php echo __("経理レビュー");?></a>
                                </li>
                            <?php } ?>
							<?php if(in_array('StockSummaryReports', $menus) || in_array('StockSummaryDetails', $menus) || in_array('StockProgressReports', $menus)) { ?>
                                <li class="dropdown">
                                    <a class="dropdown-toggle menuitemlist" data-toggle="dropdown" href="#"><?php echo __("レポート");?>
                                        <span class="caret"></span>
                                    </a>
                                    <ul class="dropdown-menu" id="menuone">
                                        <?php if(in_array('StockSummaryReports', $menus)) { ?>
                                            <li>
                                                <a class="dropdown_menu stocksummaryreports" href="<?php echo $this->webroot; ?>StockSummaryReports/index"><?php echo __("速報版");?></a>
                                            </li>
                                        <?php } ?>
                                        <?php if(in_array('StockSummaryDetails', $menus)) { ?>
                                            <li>
                                                <a class="dropdown_menu stocksummarydetails" href="<?php echo $this->webroot; ?>StockSummaryDetails/index"><?php echo __("長期滞留債権報告書");?></a>
                                            </li>
                                        <?php } ?>
                                        <?php if(in_array('StockProgressReports', $menus)) { ?>
                                            <li>
                                                <a class="dropdown_menu stockprogressreports" href="<?php echo $this->webroot; ?>StockProgressReports/index"><?php echo __("進捗");?></a>
                                            </li>
                                        <?php } ?>                                 
                                    </ul>
                                </li>
    					...
    					<ul class="nav navbar-nav navbar-right">
				        	<li>
      						...
      						<li>
					    		<a class="backperiod stockselections" href="<?=$this->webroot;?>StockSelections"><i class="fa-regular fa-circle-left"></i>&nbsp;<?php echo __('期間選択');?></a>
      						</li>
    						<li class="dropdown">
