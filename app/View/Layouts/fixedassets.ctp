...
<head>
    ...
    echo $this->Html->script('jquery.floatingscroll.min.js');
    echo $this->Html->script('jquery-confirm.js');
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="myNavbar">
                        <ul class="nav navbar-nav menu_active">
                            <?php if (in_array('AssetImports', $menus)) { ?>
                                <li>
                                    <a href="<?php echo $this->webroot; ?>AssetImports/index"  class="assetimports menuitem" ><?php echo __("固定資産データのインポート"); ?></a>
                                </li>
                            <?php } ?>
                            <?php if (in_array('Assets', $menus)) { ?>
                                <li>
                                    <a href="<?php echo $this->webroot; ?>Assets/index"  class="assets"><?php echo __("固定資産データ一覧"); ?></a>
                                </li>
                            <?php } ?>
                            <?php if (in_array('AssetProgress', $menus)) { ?>
                                <!-- additional request -->
                                <li class="dropdown">
                                    <a class="dropdown-toggle menuitemlist" data-toggle="dropdown" href="#"><?php echo __("出力レポート"); ?>
                                        <span class="caret"></span>
                                    </a>
                                    <ul class="dropdown-menu checklist" id="menuone">
                                        <li><a href="<?php echo $this->webroot; ?>AssetProgress/index"><?php echo __("進捗"); ?></a></li>
                                    </ul>
                                </li>
                            <?php } ?>
                            <?php if (in_array('Pictures', $menus)) { ?>
                                <li><a href="<?php echo $this->webroot; ?>Pictures/index" class="pictures"><?php echo __("画像リスト"); ?></a></li>
                            <?php } ?>
                        </ul>
                        <!-- right -->
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li>
                                <a class="backperiod assetselections" href="<?= $this->webroot; ?>AssetSelections"><i class="fa-regular fa-circle-left"></i>&nbsp;<?php echo __('期間選択'); ?></a>
                            </li>
                            <li class="dropdown">
