...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $(".btn-sumisho").click(function(e){
        ...
        if(errorFlag){
          ...
          $.ajax({
            type: "POST",
            url: "<?php echo $this->webroot; ?>SapSelections/add",
  ...
  function getBAList() {
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo $this->webroot; ?>SapSelections/getBa",
      data: {period: period},
      ...
      <fieldset class="scheduler-border">
          ...
          <div class="form-group">
                  ...
                  <div class="col-md-5">
                    ...
                    <?php $period =  $this->Session->read('SapSelections_PERIOD_DATE');
                      if(!empty($period)){ ?>
