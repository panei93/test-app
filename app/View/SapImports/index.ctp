    ...
    $(document).ready(function() {
        ...
        $("#uploadfile").change(function() {
            if ($(this).val() != '') {
                ...
                tempKeep = $(this).prop('files')
            }else {
                $(this).prop('files', tempKeep);
            }
        });

        $("#sap_excelremove").on('click', function() {
             $("#uploadfile").val('');
             $(".sap_excelremove").hide();
             $('.upd-file-name').hide();
             $("#upd-file-name").empty();
        ...
        var skipNoRegCode = "<?php if(!empty($skipNoRegCode)){echo $skipNoRegCode;}else{echo '';}  ?>";
        var skipDataRow = "<?php if(!empty($skipDataRow)){echo $skipDataRow;}else{echo '';}  ?>";
        
        /** Please Register BA Code **/
        if (skipNoRegCode == "skipNoRegCode") {

            $.ajax({

                url: "<?php echo $this->webroot ?>SapImports/inform_skipNoRegCode",
                type: 'post',
                dataType: 'json',
                        ...
                        buttons: {
                            ok: {
                                ...
                                action: function() {
                                    ...
                                    if (skipDataRow == "skipDataRow") {

                                        $.ajax({

                                            url: "<?php echo $this->webroot ?>SapImports/inform_SkipSlicLine",
                                            type: 'post',
                                            dataType: 'json',
                                            success: function(data) {
        ...
        } else if (skipDataRow == "skipDataRow") {

            $.ajax({

                url: "<?php echo $this->webroot ?>SapImports/inform_skipDataRow",
                type: 'post',
                dataType: 'json',
                success: function(data) {
            ...
            success: function(data) {
                ...
                if (mailSend == 1) {
                    if (data.mailType == 1) {
                        ...
                        $('#ccEmail').val(CC);
                        $('#bccEmail').val(CC);
                        document.forms[0].action = "<?php echo $this->webroot; ?>SapImports/SaveExcelFile";
                        ...
                        $('#SapImports').attr('action',
                        "<?php echo $this->webroot; ?>SapImports/SaveExcelFile");
                    }
                } else {
...
<div class="row container register_container">
    <div class="col-lg-12 col-md-12 col-sm-12">
        <h3 class=""><?php echo __('SAPデータインポート');?></h3>
        <hr>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <div class="input-group date datepicker register" data-provide="datepicker"
                            ...
                            <input type="text" class="form-control" id="refer_date" name="refer_date" value="" />
        ...
        <div class="form_test">
            <div class="row">
                <fieldset class="scheduler-border">
                    <legend class="scheduler-border"><?php echo __('SAPデータインポート');?></legend>
                    <div class="col-md-12">
                        <div class="row form-group">
                            ...
                            <div class="col-md-2 upd-file-name">
                                <div class="row d-flex flex-row">
                                    ...
                                    <div class="col-md-2 sap_excelremove" id="sap_excelremove"><i class="fa-regular fa-circle-xmark" style="color: red;font-size:1.3rem;"></i></div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <a href="<?php echo $this->webroot ?>templates/sapimports_template.xlsx" class="temp-download" ><u>Get Template <i class="fa-solid fa-file-arrow-down"></i></u> </a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
                        ...
                        <!-- <div class="col-md-8">
                            <span id="upd-file-name"></span>
                            <span class="sap_excelremove" id="sap_excelremove"><i class="fa-regular fa-circle-xmark" style="color: red;font-size:1.3rem;"></i></span>
                        </div> -->
                        <!-- <div class="col-md-8 col-xs-12 sap_excelremovelink" id="sap_excelremovelink" style="text-align: start;">
                            <a href="" class="sap_excelremove"><?php echo __('ファイルを消去');?></a>
                        </div> -->
                    </div>
                    <?php if($showSaveBtn) {?>
                    <div class="col-md-12" style="margin-top: 2rem;">
                        <div class="row mt-5">
                            <div class="col-md-2 "></div>
                            <div class="col-md-6  sap_upload_line" style="text-align: start;">
                                <button type="button" class="btn btn-success file_sap"
