...
Configure::write('Error', array(
    ...
    'level' => E_COMPILE_ERROR | E_RECOVERABLE_ERROR | E_ERROR | E_CORE_ERROR,
    'trace' => true
));
...
Configure::write('Error.handler', function (
    $code,
    $description,
    $file = null,
    $line = null,
    ...
    //CakeLog::write('debug','Something bad happened for '.$code.' '.$description.' line '.$line.'in '.$file);
});
