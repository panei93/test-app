...
class SapSelectionsController extends AppController
{
    ...
    public function add()
    {
        ...
        $response = array(
            'period'          => $this->Session->write('SapSelections_PERIOD_DATE', $period),
            'layer_code' 	  => $this->Session->write('SESSION_LAYER_CODE', $layer_code),
            'layer_name' 	  => $this->Session->write('SapSelections_BA_NAME', $layer_name),
            'l_name'         => $this->Session->write('SapSelections_name',$l_name),
            'l_code'         => $this->Session->write('SapSelections_code',$l_code)
        );
